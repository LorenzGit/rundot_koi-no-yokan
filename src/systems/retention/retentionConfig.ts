...
/**
 * Return reminders for koi-no-yokan.
 *
...
export const returnReminders = createReturnReminders({
    idPrefix: "koi-no-yokan",
    reminders: () => [
        {
            id: "d1",
            title: "Someone left you a gift",
            body: "Your daily gift is waiting — claim it before tonight.",
            delaySeconds: RETURN_DELAYS_SECONDS[0],
        },
        {
            id: "d2",
            title: "Your last date left something unsaid",
            body: "Pick the conversation back up tonight.",
            delaySeconds: RETURN_DELAYS_SECONDS[1],
        },
        {
            id: "d3",
            title: "The season is turning",
            body: "Your affection is still where you left it.",
